...
<%
	...
	//	ㄴ 댓글 삭제할 때에는 del 파라미터를 전달합니다.
	request.setCharacterEncoding("UTF-8");
	CommentDao dao = CommentDao.getInstance();
	String del = request.getParameter("del");
	
//블록 밖에서 idx와 mref 변수를 통일하고 response merthod를 if문 밖에 작성할 수도 있다.
	if(del != null && del.equals("y")){//del이 null 일 때는 첫번째 조건 false이므로 두번째 조건 equals 메소드 실행 안합니다.
		//댓글 삭제
