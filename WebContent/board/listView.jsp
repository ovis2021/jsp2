...
<ul id="main">
 ...
 <a href="${pageContext.request.contextPath}/index.jsp" class="button">홈</a></div>

</div>
<!-- 페이지 버튼을 클리갛면 url http://192.168.1.254:8082/jsp2/board/listAction.jsp 은  동일하고
		page 파라미터만 변경됩니다. 이런 경우 앞의 부분 생략하고 ? 부터 작성.
 -->
 <!-- 여기부터 아래가 헤더나 푸터처럼 작용할 수 있다. -->
<div style="width:700px; margin: auto; text-align: center;">
	...
	<a class="pagenum" href="?page=${pagelist.startPage-1 }"
	 style='<c:if test='${pagelist.startPage==1 }'>
	display:none;</c:if>' >&lt;</a>
